# home/linux/Desktop/flatpak-compat.nix — Flatpak Wayland/Fcitx5 兼容 + 权限占位
#
...
{ config, lib, pkgs, ... }:
let
  cfg = config.modules-home-linux-desktop-flatpak-compat;
in
{
  options.modules-home-linux-desktop-flatpak-compat = {
